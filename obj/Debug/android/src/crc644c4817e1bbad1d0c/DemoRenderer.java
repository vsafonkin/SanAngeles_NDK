...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SanAngles.DemoRenderer, SanAngeles", DemoRenderer.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DemoRenderer.class)
			mono.android.TypeManager.Activate ("SanAngles.DemoRenderer, SanAngeles", "", this, new java.lang.Object[] {  });
	}
